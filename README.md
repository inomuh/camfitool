...
![Image of CamFIDemoTool_v1.2_offline](https://github.com/Akerdogmus/camfitool/blob/v1.3/camfitool_v1.3_offline.png)
*Fig 1. Camera Fault Injector Tool Offline FI Configuration*

![Image of CamFIDemoTool_v1.2_realtime](https://github.com/Akerdogmus/camfitool/blob/v1.3/camfitool_v1.3_offline.png)
